...
Irplot\[Theta][\[Theta]_,\[Theta]1_]:=Evaluate[Integrate[Irplot[\[Theta],\[Phi],\[Theta]1,0],{\[Phi],0,2*\[Pi]}]];
Simplify[Series[Irplot\[Theta][\[Theta],\[Theta]1],{\[Theta]1,\[Pi]/4,1}]]
...
(*---------------------------------------------------------------------------------------------*)
(*RADIATED POWER BY A LEVITATED SPHERE + SPHERICAL EMITTER*)
(*Calculation up to 7th order. It may not run on every Mathematica version*)
(*The sphere has radius R0 and it is located in the center of the reference system*)
(*---------------------------------------------------------------------------------------------*)
(*Optical Green's function in the measurement region (free space)*)
gm[\[Theta]k_,\[Phi]k_,\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,r0_]:=Exp[I*(2*\[Pi]*r0/\[Lambda])*nr[\[Theta]k,\[Phi]k].nr[\[Theta]0,\[Phi]0]]*Exp[I*(2*\[Pi]*r0/\[Lambda])*nr[\[Theta],\[Phi]].nr[\[Theta]0,\[Phi]0]];
...
(*Simplify conditions: angles real, wavelenght positive, radius positive*)
simplfyGreenConditions={\[Lambda]>0, \[Theta]>0, \[Phi]>0, \[Phi]0>0, \[Theta]0>0, \[Phi]k>0, \[Theta]k>0, r0>0, R0>0};
(*Integrating the Green's function in r0 without approximations*)
gmR[\[Theta]k_,\[Phi]k_,\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,R0_]:=Evaluate[Integrate[gm[\[Pi]/2,\[Pi]/2,\[Theta]0,\[Phi]0,\[Theta],\[Phi],r0]*r0^2*Sin[\[Theta]0],{r0,0,R0}]];
gcR[\[Theta]k_,\[Phi]k_,\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,R0_]:=Evaluate[Integrate[gc[\[Pi]/2,\[Pi]/2,\[Theta]0,\[Phi]0,\[Theta],\[Phi],r0]*r0^2*Sin[\[Theta]0],{r0,0,R0}]];
(*Electric field to n-th order in R0/\[Lambda]*)
gm7o\[Phi]\[Theta][\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,R0_]:= Evaluate[Simplify[Normal[Series[gmR[\[Pi]/2,\[Pi]/2,\[Theta]0,\[Phi]0,\[Theta],\[Phi],R0],{R0,0,7}]], Assumptions->simplfyGreenConditions]];
Print["gm7o\[Phi]\[Theta] executed"]
gm7o\[Theta][\[Theta]0_,\[Theta]_,\[Phi]_,R0_]:= Evaluate[Integrate[gm7o\[Phi]\[Theta][\[Theta]0,\[Phi]0,\[Theta],\[Phi],R0],{\[Phi]0,0,2*\[Pi]}, Assumptions->simplfyGreenConditions]];
Print["gm7o\[Theta] executed"]
Em7det[\[Theta]_,\[Phi]_,R0_]:= Evaluate[Integrate[gm7o\[Theta][\[Theta]0,\[Theta],\[Phi],R0],{\[Theta]0,0,\[Pi]}, Assumptions->simplfyGreenConditions]];
Em6det[\[Theta]_,\[Phi]_,R0_]:=Evaluate[Simplify[Normal[Series[Em7det[\[Theta],\[Phi],R0],{R0,0,6}]], Assumptions->simplfyGreenConditions]];
Print["Em6det[\[Theta],\[Phi],R0] = ", Em6det[\[Theta],\[Phi],R0]]
(*Electric field to n-th order in R0/\[Lambda]*)
gc7o\[Phi]\[Theta][\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,R0_]:= Evaluate[Simplify[Normal[Series[gcR[\[Pi]/2,\[Pi]/2,\[Theta]0,\[Phi]0,\[Theta],\[Phi],R0],{R0,0,7}]], Assumptions->simplfyGreenConditions]];
Print["gc7o\[Phi]\[Theta] executed"]
gc7o\[Theta][\[Theta]0_,\[Theta]_,\[Phi]_,R0_]:=Evaluate[Integrate[gc7o\[Phi]\[Theta][\[Theta]0,\[Phi]0,\[Theta],\[Phi],R0],{\[Phi]0,0,2*\[Pi]}]];
Print["gc7o\[Phi]\[Theta] executed"]
Ec7det[\[Theta]_,\[Phi]_,R0_]:=Evaluate[Integrate[gc7o\[Theta][\[Theta]0,\[Theta],\[Phi],R0],{\[Theta]0,0,\[Pi]}, Assumptions->simplfyGreenConditions]];
Ec6det[\[Theta]_,\[Phi]_,R0_]:=Evaluate[Simplify[Normal[Series[Ec7det[\[Theta],\[Phi],R0],{R0,0,6}]], Assumptions->simplfyGreenConditions]];
Print["Ec6det[\[Theta],\[Phi],R0] = ", Ec6det[\[Theta],\[Phi],R0]]
(*The power is proportional to the square of the electric field*)
pm6det = Simplify[Conjugate[Em6det[\[Theta],\[Phi],R0]]*Em6det[\[Theta],\[Phi],R0], Assumptions->simplfyGreenConditions];
pm7det = Simplify[Conjugate[Em7det[\[Theta],\[Phi],R0]]*Em7det[\[Theta],\[Phi],R0], Assumptions->simplfyGreenConditions];
pc6det = Simplify[Conjugate[Ec6det[\[Theta],\[Phi],R0]]*Ec6det[\[Theta],\[Phi],R0], Assumptions->simplfyGreenConditions];
pc7det = Simplify[Conjugate[Ec7det[\[Theta],\[Phi],R0]]*Ec7det[\[Theta],\[Phi],R0], Assumptions->simplfyGreenConditions];
(*Integrals of the power in the measurement region and in the control region. Warning: different domains of integration.*)
Pm7det\[Theta] = Integrate[pm7det*Sin[\[Theta]],{\[Phi],0,2*\[Pi]}];
Pm7det[\[Theta]D_,RR0_]:=Evaluate[Simplify[Integrate[Pm7det\[Theta],{\[Theta],0,\[Theta]D}]+Integrate[Pm7det\[Theta],{\[Theta],\[Pi]-\[Theta]D,\[Pi]}], Assumptions->simplfyGreenConditions]/.{R0->RR0}];
Pm7detout[\[Theta]D_,RR0_]:=Evaluate[Simplify[Integrate[Pm7det\[Theta],{\[Theta],\[Theta]D,\[Pi]-\[Theta]D}], Assumptions->simplfyGreenConditions]/.{R0->RR0}];
Pm6det\[Theta] = Integrate[pm6det*Sin[\[Theta]],{\[Phi],0,2*\[Pi]}];
Pm6det[\[Theta]D_,RR0_]:=Evaluate[Simplify[Integrate[Pm6det\[Theta],{\[Theta],0,\[Theta]D}]+Integrate[Pm6det\[Theta],{\[Theta],\[Pi]-\[Theta]D,\[Pi]}], Assumptions->simplfyGreenConditions]/.{R0->RR0}];
Pm6detout[\[Theta]D_,RR0_]:=Evaluate[Simplify[Integrate[Pm6det\[Theta],{\[Theta],\[Theta]D,\[Pi]-\[Theta]D}], Assumptions->simplfyGreenConditions]/.{R0->RR0}];
(**)
Pc6det[\[Theta]D_,RR0_]:=Evaluate[Integrate[Integrate[pc6det*Sin[\[Theta]],{\[Phi],0,2*\[Pi]}],{\[Theta],\[Theta]D,\[Pi]/2}]/.{R0->RR0}];
Pc7det[\[Theta]D_,RR0_]:=Evaluate[Integrate[Integrate[pc7det*Sin[\[Theta]],{\[Phi],0,2*\[Pi]}],{\[Theta],\[Theta]D,\[Pi]/2}]/.{R0->RR0}];
(*Estimate of how good is the series approximation as a function of the radius R0 the levitated sphere. This is done by comparing the calcualtion
in series expansion to order 6 and order 7.*)
relativeuncertaintym[R0_]:=Evaluate[Simplify[(Pm7det[\[Theta]D,R0]-Pm6det[\[Theta]D,R0])/Pm6det[\[Theta]D,R0], Assumptions->{\[Theta]D>0,R0>0,\[Lambda]>0}]];
relativeuncertaintyc[R0_]:=Evaluate[Simplify[(Pc7det[\[Theta]D,R0]-Pc6det[\[Theta]D,R0])/Pc6det[\[Theta]D,R0], Assumptions->{\[Theta]D>0,R0>0,\[Lambda]>0}]];
(*Power ratio between the scattered light in the measurement region and in the control region in presence of the hemipsherical mirror*)
Pratio6[\[Theta]D_,R0_]:=Evaluate[Simplify[Pc6det[\[Theta]D,R0]/Pm7det[\[Theta]D,R0]]];
Pratio7[\[Theta]D_,R0_]:=Evaluate[Simplify[Pc7det[\[Theta]D,R0]/Pm7det[\[Theta]D,R0]]];
(*Power ratio between the scattered light in the measurement region and in the control region without the hemipsherical mirror*)
Pratio6out[\[Theta]D_,R0_]:=Evaluate[Simplify[Pm6detout[\[Theta]D,R0]/Pm6det[\[Theta]D,R0]]];
Pratio7out[\[Theta]D_,R0_]:=Evaluate[Simplify[Pm7detout[\[Theta]D,R0]/Pm7det[\[Theta]D,R0]]];
(*------------------------------------------------------------------*)
(*Plots and values*)
Print["relative deviation of the scattered power between 6th order to 7th order = ", relativeuncertaintyc[R0], "   (it does not depend on the angles!)"]
Print["relative deviation of the scattered power between 6th order to 7th order at the condition R0=\[Lambda]/5 -> ",N[Simplify[relativeuncertaintyc[\[Lambda]/5]]]]
(*2D axes label*)
xyzlinestyle = {Directive[Black, Thick, Dashing[None]],
Directive[Black, Thick, Dashed], Directive[Red, Thick, Dashing[None]], Directive[Red, Thick, Dashed]};
xylabl = {Style["NA",Bold,Black,lgdfontsize],Style["(P2-P4)/P2",Bold,Black,lgdfontsize]};
pltlgdxyz={Style["relative",Black,lgdfontsize]};
Plot[relativeuncertaintyc[R0]/.{\[Lambda]->1},{R0,0,0.4},PlotLegend->pltlgdxyz, LegendPosition->{-0.4,-0.2},LegendShadow->None,LegendSize->1,LegendBorder->Black,
	ImageSize->Large, AxesLabel -> xylabl , Axes -> True, Frame->frameflg, PlotStyle->xyzlinestyle, BaseStyle->{FontSize->16},
	 PlotTheme->"Monochrome", AspectRatio -> 3/4, Background->White]
xylabl = {Style["R0/\[Lambda]",Bold,Black,lgdfontsize],Style["Pc/Pm",Bold,Black,lgdfontsize]};
pltlgdxyz={Style["full NA - 2nd order",Black,lgdfontsize],Style["full NA - 4th order",Black,lgdfontsize],Style["NA=0.4 - 2nd order",Black,lgdfontsize], Style["NA=0.4 - 4th order",Black,lgdfontsize]};
LogPlot[{(Pc6det[ArcSin[0],R0]/Pm7det[ArcSin[1],R0])/.{\[Lambda]->1},(Pc7det[ArcSin[0],R0]/Pm7det[ArcSin[1],R0])/.{\[Lambda]->1},Pratio6[ArcSin[0.4],R0]/.{\[Lambda]->1},Pratio7[ArcSin[0.4],R0]/.{\[Lambda]->1}},{R0,0,0.3},PlotRange->{0.0001,1},PlotLegend->pltlgdxyz,
	LegendPosition->{-0.4,-0.2},LegendShadow->None,LegendSize->1,LegendBorder->Black,
	ImageSize->Large, AxesLabel -> xylabl , Axes -> True, Frame->frameflg, PlotStyle->xyzlinestyle, BaseStyle->{FontSize->16},
	 PlotTheme->"Monochrome", AspectRatio -> 3/4, Background->White]
xylabl = {Style["NA",Bold,Black,lgdfontsize],Style["Pc/Pm",Bold,Black,lgdfontsize]};
pltlgdxyz={Style["\[Lambda]/10 - 2nd order",Black,lgdfontsize],Style["\[Lambda]/10 - 4th order",Black,lgdfontsize],Style["\[Lambda]/5 - 2nd order",Black,lgdfontsize],Style["\[Lambda]/5 - 4th order",Black,lgdfontsize]};
LogPlot[{Pratio6[ArcSin[NA],\[Lambda]/10]/.{\[Lambda]->1},Pratio7[ArcSin[NA],\[Lambda]/10]/.{\[Lambda]->1},Pratio6[ArcSin[NA],\[Lambda]/5]/.{\[Lambda]->1},Pratio7[ArcSin[NA],\[Lambda]/5]/.{\[Lambda]->1}},{NA,0,1},
    PlotRange->{0.001,1},PlotLegend->pltlgdxyz,
	LegendPosition->{-0.4,-0.2},LegendShadow->None,LegendSize->1,LegendBorder->Black,
	ImageSize->Large, AxesLabel -> xylabl , Axes -> True, Frame->frameflg, PlotStyle->xyzlinestyle, BaseStyle->{FontSize->16},
	 PlotTheme->"Monochrome", AspectRatio -> 3/4, Background->White]
Print["scattered power ratio at conditions: with mirror, NA=0.4, R0=\[Lambda]/10 (6th order) = ", N[Simplify[Pratio6[ArcSin[0.4],\[Lambda]/10]]]]
Print["scattered power ratio at conditions: with mirror, NA=0.4, R0=\[Lambda]/10 (7th order) = ", N[Simplify[Pratio7[ArcSin[0.4],\[Lambda]/10]]]]
Print["scattered power ratio at conditions: with mirror, NA=0.4, R0=\[Lambda]/5  (6th order) = ", N[Simplify[Pratio6[ArcSin[0.4],\[Lambda]/5]]]]
Print["scattered power ratio at conditions: with mirror, NA=0.4, R0=\[Lambda]/5  (7th order) = ", N[Simplify[Pratio7[ArcSin[0.4],\[Lambda]/5]]]]
Print["scattered power ratio at conditions: without mirror, NA=0.4, R0=\[Lambda]/10 (6th order) = ", N[Simplify[Pratio6out[ArcSin[0.4],\[Lambda]/10]]]]
Print["scattered power ratio at conditions: without mirror, NA=0.4, R0=\[Lambda]/10 (7th order) = ", N[Simplify[Pratio7out[ArcSin[0.4],\[Lambda]/10]]]]
Print["scattered power ratio at conditions: without mirror, NA=0.4, R0=\[Lambda]/5  (6th order) = ", N[Simplify[Pratio6out[ArcSin[0.4],\[Lambda]/5]]]]
Print["scattered power ratio at conditions: without mirror, NA=0.4, R0=\[Lambda]/5  (7th order) = ", N[Simplify[Pratio7out[ArcSin[0.4],\[Lambda]/5]]]]
