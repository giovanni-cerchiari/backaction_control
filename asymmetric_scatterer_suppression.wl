...
gmn1[\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,r0_]:= Evaluate[Simplify[Normal[Series[gm[\[Pi]/2,0,\[Theta]0,\[Phi]0,\[Theta],\[Phi],r0],{r0,0,1}]], Assumptions->simplfyGreenConditions]];
gcn1[\[Theta]0_,\[Phi]0_,\[Theta]_,\[Phi]_,r0_]:= Evaluate[Simplify[Normal[Series[gc[\[Pi]/2,0,\[Theta]0,\[Phi]0,\[Theta],\[Phi],r0],{r0,0,1}]], Assumptions->simplfyGreenConditions]];
...
aryz2=Graphics3D[{Blue,Arrowheads[infoarrowtip],Arrow[Tube[{{0,0,-0.8*infoarrowl},{0,0,infoarrowl}},infoarrowdia]]}];
...
pltlgdxyz={"object", "symmetric", "asym.", "image"};
...
Print["---------------------------"]
Print["Asymmetric shape oriented on y-axis"]
...
{\[Phi],0,2*\[Pi]}, PlotRange->{{-0.15,0.15},{-0.15,0.15}}, AxesLabel -> xylabl, PlotLegends->legends, Axes -> True]
...
Print["---------------------------"]
Print["Asymmetric shape oriented in the xy-plane and rotating about the z axis"]
Animate[PolarPlot[{(2*Sqrt[\[Pi]])^(-1)*SphericalHarmonicY[0,0, \[Pi]/2, \[Phi]], fr[mr[asycoeff,\[Pi]/2,\[Phi]1],1,\[Pi]/2,\[Phi]],
(2*Sqrt[\[Pi]])^(-1)*SphericalHarmonicY[0,0, \[Pi]/2, \[Phi]]+fr[mr[asycoeff,\[Pi]/2,\[Phi]1],1,\[Pi]/2,\[Phi]]},{\[Phi],0,2*\[Pi]}, PlotRange->{{-0.15,0.15},{-0.15,0.15}},AxesLabel->xylabl],{\[Phi]1,0,2*\[Pi]}]

Print["---------------------------"]
Print["Asymmetric shape oriented in the yz-plane and rotating about the x axis"]
Animate[PolarPlot[{(2*Sqrt[\[Pi]])^(-1)*SphericalHarmonicY[0,0, \[Theta], 0], fr[mr[asycoeff,\[Pi]/2,\[Phi]1],1,\[Theta],0],
(2*Sqrt[\[Pi]])^(-1)*SphericalHarmonicY[0,0, \[Theta], 0]+fr[mr[asycoeff,\[Pi]/2,\[Phi]1],1,\[Theta],0]},{\[Theta],0,2*\[Pi]}, PlotRange->{{-0.15,0.15},{-0.15,0.15}},AxesLabel->xylabl],{\[Phi]1,0,2*\[Pi]}]
...
Ersc1[\[Theta]\[Theta]_,\[Phi]\[Phi]_,\[Theta]1_,\[Phi]1_]:=Evaluate[Integrate[Integrate[fr[mr[c0,\[Theta]1,\[Phi]1],r,\[Theta],\[Phi]]*Sin[\[Theta]]*gcn1[\[Theta],\[Phi],\[Theta]n,\[Phi]n,1],{\[Theta],0,\[Pi]}],{\[Phi],0,2*\[Pi]}]/.{\[Theta]n->\[Theta]\[Theta], \[Phi]n->\[Phi]\[Phi]}];
Ersc2[\[Theta]\[Theta]_,\[Phi]\[Phi]_,\[Theta]1_,\[Phi]1_]:=Evaluate[Integrate[Integrate[Integrate[fr[mr[c0,\[Theta]1,\[Phi]1],r0,\[Theta],\[Phi]]*r0^2*Sin[\[Theta]]*gcn1[\[Theta],\[Phi],\[Theta]n,\[Phi]n,r0],{\[Theta],0,\[Pi]}],{\[Phi],0,2*\[Pi]}],{r0,0,1}]/.{\[Theta]n->\[Theta]\[Theta], \[Phi]n->\[Phi]\[Phi]}];
